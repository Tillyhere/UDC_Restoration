...
class LPLRNet_XX(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_XX, self).__init__()
        ...
        self.conv2_3 = nn.Conv2d(32, 3, 3, padding=1)
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_XVIII(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
