...
class LPLRNet_B(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_B, self).__init__()
        ...
        self.conv2_1 = nn.Conv2d(19,32,3,padding=1)
        ...
        self.conv3_1 = nn.Conv2d(14,16,3,padding=1)
    ...
    def forward(self, real_A_full):
        ...
        high_with_low2 = torch.cat((high1_up,pyr_A[-3]), dim=1)
        ...
        high_with_low3 = torch.cat((high2_up,fake_B_up, pyr_A[-4]), dim=1)
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_B(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
