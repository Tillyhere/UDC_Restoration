...
class ESPLRNet(nn.Module):
    def __init__(self, in_c=4, out_c=3, args=None):
        ...
        self.res1_a = res_block(50)
        self.res1_b = res_block(50)
        self.res1_c = res_block(50)
        self.res1_d = res_block(50)
        
        self.res2_a = dmodule(50,50)
        self.res2_b = dmodule(50,50)
        self.res2_c = dmodule(50,50)
        self.res2_d = dmodule(50,50)
        
        self.res3_a = dmodule(50,50)
        self.res3_b = dmodule(50,50)
        self.res3_c = dmodule(50,50)
        self.res3_d = dmodule(50,50)
...
class LPLRNet_Q(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_Q, self).__init__()
        ...
        self.conv0 = nn.Conv2d(200,256,3,padding=1)
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_Q(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
