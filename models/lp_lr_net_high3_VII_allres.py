...
class ESPLRNet(nn.Module):
    def __init__(self, in_c=4, out_c=3, args=None):
        ...
        self.res2_a = res_block(48)
        self.res2_b = res_block(48)
        self.res2_c = res_block(48)
        self.res2_d = res_block(48)
...
class LPLRNet_VII_allres(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_VII_allres, self).__init__()
