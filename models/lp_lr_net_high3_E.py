...
class ESPLRNet(nn.Module):
    def __init__(self, in_c=4, out_c=3, args=None):
        ...
        self.res1_a = dmodule(48,48)
        self.res1_b = dmodule(48,48)
        self.res1_c = dmodule(48,48)
        self.res1_d = dmodule(48,48)
...
class LPLRNet_E(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_E, self).__init__()
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_E(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
