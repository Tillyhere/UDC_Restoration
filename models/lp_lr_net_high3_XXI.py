...
class LPLRNet_XXI(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_XXI, self).__init__()
        ...
        self.resblock1_2 = modifiedResBlock(64)
        self.conv1_3 = nn.Conv2d(64, 32, 3, padding=1)
        self.conv1_4 = nn.Conv2d(32, 3, 3, padding=1) 
        ...
        self.resblock2_2 = modifiedResBlock(32)
        self.conv2_3 = nn.Conv2d(32, 16, 3, padding=1)
        self.conv2_4 = nn.Conv2d(16, 3, 3, padding=1)
        #self.resblock2_2 = ResidualBlock(64)
        
        #self.calayer3 = CALayer(16)
        self.conv3_1 = nn.Conv2d(12, 12, 3, padding=1)
        self.conv3_2 = nn.Conv2d(12, 4, 1)
        #self.conv3_3 = nn.Conv2d(64,3,3,padding=1)
        self.resblock3_1 = modifiedResBlock(16)
        # self.resblock3_2 = modifiedResBlock(16)
        self.conv3_3 = nn.Conv2d(16, 3, 3, padding=1)
    ...
    def forward(self, real_A_full):
        ...
        out2 = self.conv2_3(high2)
        out2 = self.conv2_4(out2)
        fake_B_up = self.lap_pyramid.upsample(fake_B_up+out2)+pyr_A[-4]
        
        high_with_low3 = torch.cat((high2_up,y_3_up,pyr_A[-4]), dim=1)
        high3_1 = self.conv3_1(high_with_low3)+high_with_low3
        high3_2 = self.conv3_2(high3_1)
        high3 = self.resblock3_1(torch.cat((high3_1, high3_2), dim=1))
        # high3 = self.resblock3_2(high3)
        #high3 = self.resblock3_2(high3)
        #high3 = self.calayer3(high3)
        #high3_up = F.pixel_shuffle(high3, 2)
        out3 = self.conv3_3(high3)
        #high3 = self.conv3_3(high3)

        return fake_B_up+out3
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_XXI(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
