...
class DilatedParllelResidualBlockB_a(nn.Module):
    '''
    This class defines the ESP block, which is based on the following principle
        Reduce ---> Split ---> Transform --> Merge
    '''
    def __init__(self, nIn, nOut, add=True):
        ...
        n1 = nOut - 4*n
        self.c1 = C(nIn, n, 1, 1)
        self.c1_d = CDilated(n, n1, 3, 1, 1) # dilation rate of 2^0
        self.c1_r = C(n,n,3)
        self.c2_d = CDilated(n, n, 3, 1, 2)
        self.c2_r = C(n,n,3)
        self.c3_d = CDilated(n, n, 3, 1, 4)
        self.c3_r = C(n,n,3)
        self.c4_d = CDilated(n, n, 3, 1, 8)
        self.c4_r = C(n,n,3)
        self.c5_d = CDilated(n, n, 3, 1, 16)
...
class ESPLRNet(nn.Module):
    def __init__(self, in_c=4, out_c=3, args=None):
        ...
        dmodule = DilatedParllelResidualBlockB_a
...
class LPLRNet_X(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_X, self).__init__()
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_S(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
