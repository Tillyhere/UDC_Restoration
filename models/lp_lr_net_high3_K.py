...
#channel 48, res+2DuESP+res, with lr_features
ex = Experiment("LPLRNet_K")
...
class DuESP(nn.Module):
     def __init__(self, nIn, nOut, add=True):
        ...
        self.dmodule1 = dmodule(nIn,nOut)
        self.dmodule2 = dmodule(nIn,nOut)
    
     def forward(self,x,res):
        x_1 = self.dmodule1(x)
        x_2 = x_1+res
        x_3 = self.dmodule2(x_2)
        return x_3,x_2
...
class ESPLRNet(nn.Module):
    def __init__(self, in_c=4, out_c=3, args=None):
        ...
        self.res3_c = res_block(48)
        self.res3_d = res_block(48)
...
class LPLRNet_K(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_K, self).__init__()
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_K(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
