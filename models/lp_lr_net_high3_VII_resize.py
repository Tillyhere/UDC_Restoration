...
class LPLRNet_VII_resize(nn.Module):
    def __init__(self, args,nrb_low=5, nrb_high=2, num_high=3):
        super(LPLRNet_VII_resize, self).__init__()
    ...
    def forward(self, real_A_full):
        ...
        pyr_A[-1] = fake_B_low
        fake_B_up = F.upsample(fake_B_low, scale_factor = 8, mode = 'bicubic')
...
#    from ptflops import get_model_complexity_info
    ...
    model = LPLRNet_VII_1(nrb_low=5, nrb_high=3, num_high=3,args=args).to("cuda")    
